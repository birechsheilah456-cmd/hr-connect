    ...
    <div className="flex min-h-screen w-full bg-white font-sans text-slate-900">
      ...
      <div className="flex w-full flex-col justify-center bg-white px-6 py-12 sm:px-16 md:px-24 lg:w-5/12">
        <div className="mx-auto w-full max-w-md space-y-8">
          {message && (
            <div
              className={`p-4 rounded-2xl text-sm ${message.type === "success" ? "bg-emerald-50 text-emerald-700 border border-emerald-100" : "bg-red-50 text-red-700 border border-red-100"}`}
            >
              {message.text}
            </div>
          )}
            ...
            <div className="space-y-8">
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-12 py-3.5 border border-slate-200 rounded-2xl focus:outline-none focus:border-blue-600 transition"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-slate-900 hover:bg-black disabled:bg-slate-700 text-white py-4 rounded-2xl font-semibold flex items-center justify-center gap-2 transition-all"
                >
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3.5 border border-slate-200 rounded-2xl focus:outline-none focus:border-blue-600"
