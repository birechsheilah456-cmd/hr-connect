              ...
              <div className="space-y-5 py-4">
                  ...
                  <Select value={newAttendance.name} onValueChange={handleEmployeeSelect}>
                    ...
                    <SelectContent className="max-h-60">
                      ...
                      {employeeList.map(emp => (
                        ...
                        <SelectItem key={emp.name} value={emp.name} className="py-2 cursor-pointer">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input type="time" value={newAttendance.clockIn} onChange={(e) => setNewAttendance({ ...newAttendance, clockIn: e.target.value })} className="mt-2 h-11" />
